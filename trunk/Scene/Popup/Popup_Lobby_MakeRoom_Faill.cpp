#include "stdafx.h"
#include "Popup_Lobby_MakeRoom_Faill.h"
...
Popup_Lobby_MakeRoom_Faill::Popup_Lobby_MakeRoom_Faill(void)
{
	//< 배경판 이미지
...
//< 초기화
void Popup_Lobby_MakeRoom_Faill::init( void )
{
	//< 지정 이미지 로드
	loadImage();
...
//< 업데이트
void Popup_Lobby_MakeRoom_Faill::update( POINT mousePos )
{
	//< 버튼 
	...
	//< 팝업 멘트
	font->LoadText( "방만들기 실패..", popupImage->getRect(), 
		"HY헤드라인M",
		30, ALIGN_CENTER, 255,255,255 );
}

//< 랜더
void Popup_Lobby_MakeRoom_Faill::render( HDC hdc )
{
	//< 투명 이미지 랜더
...
//< 지우기
void Popup_Lobby_MakeRoom_Faill::release( void )
{
	//< 불러온 이미지 지우기
...
//< 이미지 불러오기
void Popup_Lobby_MakeRoom_Faill::loadImage( void )
{
	//< 알파 이미지
...
//< 이벤트처리
LRESULT	Popup_Lobby_MakeRoom_Faill::StateProc( HWND wnd, UINT msg, WPARAM wparam, LPARAM lparam )
{
	switch( msg )
	{
	//< 마우스를 땔때 
